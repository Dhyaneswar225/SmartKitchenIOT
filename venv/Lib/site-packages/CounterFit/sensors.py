...
class GasSensor(FloatSensorBase):
    def __init__(self, port: str, unit: str = "ppm"):
        # Set reasonable valid range for gas sensor in ppm, e.g., 0 - 1000 ppm
        super().__init__(port, 0.0, 1000.0)
        self.__unit = unit
    ...
    @staticmethod
    def sensor_units() -> List[str]:
        # List of possible units for gas concentration, typically ppm (parts per million)
        return ["ppm", "ppb", "mg/m3"]